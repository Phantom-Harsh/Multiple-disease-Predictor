...
if (selected == 'HOME'):
    ...
    st.image(new_image)
    st.text("Welcome to our revolutionary web application that harnesses the power of machine learning and advanced algorithms to predict and assess various diseases. With a user-friendly interface, our app allows you to input relevant information and receive accurate predictions for conditions like heart disease, hepatitis, Parkinson's disease, diabetes, pneumonia, and liver disease.Our cutting-edge models, trained on extensive datasets, provide reliable insights into your health. Whether you're concerned about your cardiovascular health, liver function, or risk factors for diabetes, our app has you covered. Simply enter your details, and our intelligent algorithms will analyze the data to generate personalized predictions.In addition to disease predictions, our app features an AI-powered chatbot, equipped with state-of-the-art language models. Chat with our virtual doctor and get expert advice on various health-related queries.With our web application, you can take charge of your well-being, make informed decisions, and seek timely medical intervention when necessary. Experience the future of healthcare with our comprehensive disease prediction app and embark on a journey towards a healthier life.")
